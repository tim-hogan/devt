    ...
    <div id="main">
        <div id='form'>
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                    ...
                    <tr><td class='td2'>NEW PASSWORD</td><td><input id="p1" type='password' name = 'newpw'></td></tr>
                    <tr><td class='td2'>REPEAT PASSWORD</td><td><input id="p2" type='password' name = 'newpw2'></td></tr>
